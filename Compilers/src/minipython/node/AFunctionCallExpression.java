...
public final class AFunctionCallExpression extends PExpression
{
    private TId _id_;
    ...
    public Object clone()
    {
        return new AFunctionCallExpression(
            (TId) cloneNode(_id_),
    ...
    {
        ((Analysis) sw).caseAFunctionCallExpression(this);
    }
    ...
    private class ArgumentsList_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AFunctionCallExpression.this))
            {
                node.parent().removeChild(node);
            }
